...
//		
//		std::vector<std::string> tabNames = {"Tab - 1","Tab - 2","Tab - 3" };
//		gui.add(uiHelper::makeTab(theme, 30,sf::Vector2f(70,40), tabNames,tabNames.size()));
//		
//
//
...
//		{
//			tgui::Button::Ptr exit = gui.get<tgui::Button>("Exit Button");
//			exit->disable();
//		}
//		else
//		{
